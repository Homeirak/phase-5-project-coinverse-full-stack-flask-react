...
from routes.marketroute import MarketResource, WatchlistMarketResource, TradeMarketResource, CryptoListResource
...
from routes.withdrawalroute import WithdrawalResource
from models import User, Crypto, Holding, Trade, Watchlist, PortfolioSnapshot, PriceCache
...
api.add_resource(CryptoListResource, '/api/cryptos')
api.add_resource(
...
api.add_resource(WithdrawalResource, '/withdraw', '/api/withdraw')
